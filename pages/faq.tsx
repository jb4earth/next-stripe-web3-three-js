...
const items = [
  {title: '𝕎𝕠𝕣𝕜𝕤𝕙𝕠𝕡 ℙ𝕣𝕚𝕠𝕣𝕚𝕥𝕪', data: '', link: true},
  {title: '𝕊𝕔𝕙𝕠𝕝𝕒𝕣𝕤𝕙𝕚𝕡', data: 'Help to make the difference in the democratisation of Architecture Technology.'},
  {title: '𝔼𝕩𝕙𝕚𝕓𝕚𝕥𝕚𝕠𝕟', data: 'Opportunity to show your work in NovaDAO Gallery and Exhibitions.'},
...
<p>NovaDAO NFT!  will be available for use in Decentraland.<br/>
Cherry on the top, our NFT has  additional utilities.
</p>
  <h1>  𝕎𝕙𝕒𝕥 𝕒𝕣𝕖 𝕥𝕙𝕖  𝕦𝕥𝕚𝕝𝕚𝕥𝕚𝕖𝕤?</h1>
        ...
        return(
          <li>
              <div className="faq-item cart-style-background">
                <h2>{i}. {item.title}</h2>
                <p>{item.data}</p>
                <a className="faq-a" >Checkout our Youtube</a>
              </div>
          </li>
      )} else {return(
        <li>
